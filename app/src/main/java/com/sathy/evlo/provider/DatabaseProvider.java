    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriType) {
            ...
            case EXPENSES:
                ...
                text = "SELECT e._id, e.expense_date, e.source_id, e.amount, e.notes, s.name From expense e INNER JOIN source s ON e.source_id = s._id ";
                text = text + " Order By e.expense_date DESC, e._id DESC LIMIT 20";
                break;
            case EXPENSE_ID:
